...
function __fish_print_docker_containers --description 'Print a list of docker containers'
  docker ps --no-trunc $argv --format "{{.Names}}"
end

function __fish_print_docker_containers_all --description 'Print a list of all docker containers'
  __fish_print_docker_containers --all
end

function __fish_print_docker_containers_running --description 'Print a list of running docker containers'
  __fish_print_docker_containers --filter status=running
end

function __fish_print_docker_containers_stopped --description 'Print a list of stopped docker containers'
  __fish_print_docker_containers --filter status=exited --filter status=created
end
...
complete -c docker -A -f -n '__fish_seen_subcommand_from attach' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from commit' -a '(__fish_print_docker_containers_all)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from diff' -a '(__fish_print_docker_containers_all)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from exec' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from export' -a '(__fish_print_docker_containers_all)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from inspect' -a '(__fish_print_docker_containers_all)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from kill' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from logs' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from port' -a '(__fish_print_docker_containers_running)' -d "Container"

# pause
complete -c docker -f -n '__fish_docker_no_subcommand' -a pause -d 'Pause all processes within a container'
complete -c docker -A -f -n '__fish_seen_subcommand_from pause' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from restart' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from rm' -a '(__fish_print_docker_containers_stopped)' -d "Container"
complete -c docker -A -f -n '__fish_seen_subcommand_from rm' -s f -l force -a '(__fish_print_docker_containers_all)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from start' -a '(__fish_print_docker_containers_stopped)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from stats' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from stop' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from top' -a '(__fish_print_docker_containers_running)' -d "Container"

# unpause
complete -c docker -f -n '__fish_docker_no_subcommand' -a unpause -d 'Unpause a paused container'
complete -c docker -A -f -n '__fish_seen_subcommand_from unpause' -a '(__fish_print_docker_containers_running)' -d "Container"
...
complete -c docker -A -f -n '__fish_seen_subcommand_from wait' -a '(__fish_print_docker_containers_running)' -d "Container"
